...
#parentDir = 'N:\\Vardan_Andriasyan\\Morphosphere\\SpVSDead\\'
...
# batch_size = len(trainingSet[0])
validationError = evaluate_lenet5(learning_rate=0.5, n_epochs=200,
                    nkerns=[20, 50], batch_size=100, numberOfClasses=2)
