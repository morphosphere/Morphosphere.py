...
dataTableClassifiedPath = parentDir +'\\'+ '20170509_HSV_dying_classified.csv'
...
for image in range(0,len(dataTableClassified)-1,1):
    if dataTableClassified[image, 15] == 'Training' or dataTableClassified[image, 15] ==  'Test' or dataTableClassified[image, 15] ==  'Validation':
        ...
        if dataTableClassified[image,5] == '006':
...
# Pickle dictionary
pickle.dump(segmentationData, open( "segmentationData4Classes_HSV.p", "wb" ) )
...
segmentationData = pickle.load( open("segmentationData4Classes_HSV.p", "rb" ) )
numberOfClasses = 4
...
pickle.dump( cnnData, open( "cnnData_HSV.p", "wb" ) )
...
cnnData = pickle.load(open( "cnnData_HSV.p", "rb" ) )
