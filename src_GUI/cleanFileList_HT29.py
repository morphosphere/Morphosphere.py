...
analysisTitle ='20160512_HT29complete'
...
# col 14 = "class"
# col 15 = "set"
# col 16 = "setClassCounter"
# col 17 = "imageHeight"
# col 18 = "imageWidth"
# col 19 = "segmentedImage"
# col 20 = "reducedImage"
# Sum =  21 columns
...
for image in range(0,len(dataTable),1):
    ...
    #platePattern = re.compile('4') ### use platePattern.match(dataTable[image,2])
    #rowPattern = re.compile('[A-P]') ### use rowPattern.match(dataTable[image,3])
    columnPattern = re.compile('[0][1-6]')
    channelPattern = re.compile('1|3|4|5')
    if channelPattern.match(dataTable[image,9]) and columnPattern.match(dataTable[image,4]):
